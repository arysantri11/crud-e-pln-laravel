      ...
      <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto overflow-x-hidden">
        ...
        <div class="row d-block mb-4">
          <div class="col d-flex justify-content-center mb-2">
            <img src="{{ asset('img/user.jpg') }}" alt="photo" width="100px" class="rounded-circle">
          </div>
        ...
        <ul class="nav flex-column mb-auto">
          ...
          <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2 {{ Request::is('dashboard/golongan*') ? 'active' : '' }}" href="/dashboard/golongan">
        ...
        <ul class="nav flex-column mb-auto">
          <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2" href="/logout" onclick="return confirm('Yakin ingin logout?');">
